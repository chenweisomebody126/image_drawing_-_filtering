...
class StateManager {
 public:
   ...
   *
   */
  void UndoOperation(PixelBuffer *curr_state);
   ...
   *
   */
  void RedoOperation(PixelBuffer *curr_state);

  void update_states(PixelBuffer *curr_state);
 ...
 private:
  ...
  std::vector<PixelBuffer> undo_vector_;
  std::vector<PixelBuffer> redo_vector_;
  bool enable_undo_;
  bool enable_redo_;
};
